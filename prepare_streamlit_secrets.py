"""
Generate Streamlit Cloud secrets TOML from local .env + credentials/sheets_service.json.
...
def main() -> None:
    ...
    # Escape private key for TOML (single line with \n)
    private_key = sa["private_key"].replace("\n", "\\n")

    print("# Paste everything below into Streamlit Cloud → Settings → Secrets\n")
    ...
    print()
    print("# Then share your Google Sheet with this email (Editor):")
